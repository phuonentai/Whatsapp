...
Defines the Playwright e2e coverage for the Siigo onboarding flow: wizard happy path, kill-switch, assisted setup, admin onboarding view, deal-stage invoicing gating, and cross-organization isolation, all running against the offline stack.
