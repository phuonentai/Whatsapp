...
Defines the pagination contract for the CRM list endpoints: org-scoped, filter-matched total counts alongside the page's data array so clients can render accurate page controls.
