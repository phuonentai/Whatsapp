...
Defines the AI chat streaming behavior over the cognitive endpoint: SSE token streaming, metered token integrity, credit-guard rejection before stream start, and frontend incremental rendering with a non-streaming fallback.
