...
Define the E2E behavior of the CRM tags (Etiquetas) module: tag creation and deletion, duplicate-name validation, and tagging/untagging of CRM entities through the browser UI.

## Requirements

### Requirement: Tag CRUD via browser UI

The system SHALL support tag creation and deletion through the tag manager UI, verified by E2E tests.
...
The system SHALL support tagging and untagging of CRM entities, verified by E2E tests.
